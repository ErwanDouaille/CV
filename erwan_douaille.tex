...
%ASPIC 2018
	\textsc{Mars} 2018& Ingénieur R\&D \textbf{Aspic Technologies}, {\small Tourcoing, \textit{1 an 2 mois}}\\
        &{$\rhd$ \small développement de CinmeaticVR, logiciel de spatialisation audio pour vidéo 360}\\	
...
%DEFROST 2017
	\textsc{Juillet} 2017& Ingénieur R\&D \textbf{INRIA} équipe \textbf{DEFROST}, {\small Lille, \textit{8 mois}}\\
        &{$\rhd$ \small ajout d'un plugin de communication, d'un affichage GL/SL raymarching et maintenance de Sofa-Framework}\\	
...
%MINT 2015
	\textsc{Novembre } 2015& Ingénieur R\&D système interactif \textbf{INRIA} équipe \textbf{MINT}, {\small Lille, \textit{1 an 6 mois}}\\
        &{$\rhd$ \small hack weston/wayland, déformation d'image, détection de mouvement, etc.}\\	
